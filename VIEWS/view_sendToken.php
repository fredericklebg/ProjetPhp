...
<div class="container">
    ...
    <section class="col-lg-12 text-center">
        ...
        <form class="changebloc"  action="http://tpphp.alwaysdata.net/ProjetPhp/?page=accueil&action=replacePass" method="post">
            ...
            <input type="submit" name="action" value="replacePass"/> <br>
        </form>
